...
app.use((req, res, next) => {
  const allowedOrigins = [
    "http://localhost/",
    "https://food-express.onrender.com",
  ];
  ...
  try {
    ...
    woo_api._stores = {
      ...
      get_all_stores_local: async function (lat, long, radius) {
        let url =
          "https://restful.co.il/wp-json/wcfmmp/v1/store-vendors?wcfmmp_radius_lat=" +
          lat +
          "&wcfmmp_radius_long=" +
          long +
          "";
      ...
      get_products: async function (store_id) {
        let url =
          "https://restful.co.il/wp-json/wcfmmp/v1/store-vendors/" +
          store_id +
          "/products";
        request.get(
          {
      ...
      get: async function (store_id) {
        let url =
          "https://restful.co.il/wp-json/wcfmmp/v1/store-vendors/" + store_id;
        request.get(
          {
            url: url,
            json: true,
        ...
        return await woo_api
          ...
          .then((response) => {
            for (var i = response.data.length - 1; i >= 0; i--) {
              ...
              item.location =
                "https://www.google.com/maps/place/%D7%A4%D7%99%D7%A6%D7%94+%D7%A8%D7%95%D7%96%D7%9E%D7%A8%D7%99%D7%9F+%7C+%D7%A4%D7%99%D7%A6%D7%94+%D7%9B%D7%A9%D7%A8%D7%94+%D7%91%D7%AA%D7%9C+%D7%90%D7%91%D7%99%D7%91%E2%80%AD%E2%80%AD/@32.0664064,34.7830238,15z/data=!4m2!3m1!1s0x0:0x1ff261d82d28f753";
        ...
        .get(url, (res) => {
          ...
          res.on("end", () => {
            try {
              ...
              fs.writeFile("www/data.json", json, "utf8", () => {
                return;
              });
            } catch (error) {
    ...
    app.get("/api/products/local", (req, res) => {
      ...
      let radius = "1";
      woo_api._stores
        .get_all_stores_local(lat, long, radius)
        .then((response) => {
          res.json(response);
        });
    });
